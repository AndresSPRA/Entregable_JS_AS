...
const buscarPeliculas = (peliculas, titulo, genero) => {
  return peliculas.filter(pelicula =>
    ...
    //Esta es la version compacta del mismo if:
    // return !titulo?pelicula.genero.includes(genero):!genero?pelicula.titulo.includes(titulo)
    // :((pelicula.titulo.includes(titulo)) && (pelicula.genero.includes(genero)))
    // no la use por que es muy ilegible
